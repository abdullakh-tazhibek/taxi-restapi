...
const isUserExists = "SELECT * FROM users WHERE phone = $1 AND password = $2";
...
const changeRole =
  "UPDATE user SET role = CASE WHEN role = 'жолаушы' THEN 'жүргізуші' WHEN role = 'жүргізуші' THEN 'жолаушы' ELSE role END WHERE id = $1;";
